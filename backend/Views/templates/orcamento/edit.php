<div class="page-wrapper">
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Editar #<?= htmlspecialchars($orcamento['id_orcamento']) ?></li>
        </ol>
    </nav>
        ...
        <div class="page-header-content">
            <div class="page-title-group">
                <h1 class="page-title">
                    ...
                    Editar Orçamento #<?= htmlspecialchars($orcamento['id_orcamento']) ?>
                </h1>
                <p class="page-subtitle">Atualize as informações do orçamento</p>
            </div>
        </div>
    </div>
    ...
    <!-- Formulário -->
    <div class="form-card">
        <form action="/backend/orcamento/atualizar/<?= htmlspecialchars($orcamento['id_orcamento']) ?>" method="post" id="formOrcamento">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                            ...
                            <select id="id_cliente" name="id_cliente" class="form-control" required>
                                <?php foreach ($usuarios as $usuario): ?>
                                    <option value="<?= htmlspecialchars($usuario['id_usuario']) ?>"
                                        <?= ($usuario['id_usuario'] == $orcamento['id_cliente']) ? 'selected' : '' ?>>
                        ...
                        <small class="form-hint">Cliente responsável por este orçamento</small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="date" 
                                   ...
                                   name="data_orcamento" 
                                   class="form-control"
                                   value="<?= htmlspecialchars($orcamento['data_orcamento']) ?>"
                                   required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" 
                                   ...
                                   class="form-control" 
                                   min="1"
                                   value="<?= htmlspecialchars($orcamento['total_item_orcamento']) ?>"
                                   required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" 
                                   ...
                                   class="form-control" 
                                   value="R$ <?= number_format($orcamento['valor_orcamento'], 2, ',', '.') ?>"
                                   required>
                        </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="status-selector">
                            <label class="status-option">
                                <input type="radio" name="status_orcamento" value="aguardando" 
                                    <?= ($orcamento['status_orcamento'] == 'aguardando') ? 'checked' : '' ?>>
                            ...
                            <label class="status-option">
                                <input type="radio" name="status_orcamento" value="em_analise"
                                    <?= ($orcamento['status_orcamento'] == 'em_analise') ? 'checked' : '' ?>>
                            ...
                            <label class="status-option">
                                <input type="radio" name="status_orcamento" value="aprovado"
                                    <?= ($orcamento['status_orcamento'] == 'aprovado') ? 'checked' : '' ?>>
                            ...
                            <label class="status-option">
                                <input type="radio" name="status_orcamento" value="recusado"
                                    <?= ($orcamento['status_orcamento'] == 'recusado') ? 'checked' : '' ?>>
