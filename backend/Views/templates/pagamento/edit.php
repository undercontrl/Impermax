<div class="page-wrapper">
        ...
        <div class="page-header-content">
            <div class="page-title-group">
                <h1 class="page-title">
                    ...
                    Editar Pagamento #<?= htmlspecialchars($pagamento['id_pagamento']) ?>
                </h1>
                <p class="page-subtitle">Atualize as informações do pagamento</p>
            </div>
    ...
    <!-- Formulário -->
    <div class="form-card">
        <form action="/backend/pagamento/atualizar" method="POST" id="formPagamento">
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Dados do cliente e data do pagamento</p>
                </div>
                    ...
                    <select name="id_cliente" id="id_cliente" class="form-select" required>
                        ...
                        <?php foreach($usuarios as $usuario): ?>
                            <option value="<?= $usuario['id_usuario'] ?>" 
                                    <?= $usuario['id_usuario'] == $pagamento['id_cliente'] ? 'selected' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="date" 
                           ...
                           id="data_pagamento" 
                           class="form-input"
                           value="<?= htmlspecialchars($pagamento['data_pagamento']) ?>"
                           required>
                </div>
            </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Atualize o valor devido e as formas de pagamento</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" 
                               ...
                               step="0.01"
                               min="0"
                               value="<?= htmlspecialchars($pagamento['total_devedor']) ?>"
                               required
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   min="0"
                                   value="<?= htmlspecialchars($pagamento['dinheiro']) ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   min="0"
                                   value="<?= htmlspecialchars($pagamento['debito']) ?>"
                                   onchange="calcularTotalPago()">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   min="0"
                                   value="<?= htmlspecialchars($pagamento['credito']) ?>"
                                   onchange="calcularTotalPago()">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   min="0"
                                   value="<?= htmlspecialchars($pagamento['pix']) ?>"
                                   onchange="calcularTotalPago()">
                        </div>
                    </div>
                </div>
