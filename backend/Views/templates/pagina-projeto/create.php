<div class="page-wrapper">
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/backend/pagina-projeto/listar">Pagina de Projeto</a></li>
        ...
        <div class="page-header-content">
            <div class="page-title-group">
                <h1 class="page-title">
                    ...
                    Novo Projeto para o Site
                </h1>
                <p class="page-subtitle">Adicione um projeto com imagem para exibição no site público</p>
            </div>
        </div>
    </div>
    ...
    <!-- Formulário -->
    <div class="form-card">
        <form action="/backend/pagina-projeto/salvar" method="POST" enctype="multipart/form-data" id="formPaginaProjeto">
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="textarea-wrapper">
                            ...
                            <textarea id="descricao_projeto" 
                                      ...
                                      rows="6"
                                      placeholder="Descreva o projeto de forma atrativa para os visitantes do site. Destaque os benefícios e diferenciais..."
                                      minlength="10"
                                      maxlength="1000"
                                      required></textarea>
                        </div>
            ...
            <div class="info-box">
                ...
                <div class="info-content">
                    <strong>Dica:</strong> Use imagens de alta qualidade e que representem bem o projeto. 
                    A imagem será redimensionada automaticamente para o tamanho ideal. 
                    O projeto será criado como <strong>Inativo</strong> por padrão - você pode ativá-lo depois na listagem.
                </div>
            </div>
