<div class="page-wrapper">
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/backend/pagina-projeto/listar">Pagina de Projetos</a></li>
            <li class="breadcrumb-item active" aria-current="page">Editar Projeto #<?= $projeto['id_projeto'] ?></li>
        </ol>
    </nav>
        ...
        <div class="page-header-content">
            <div class="page-title-group">
                <h1 class="page-title">
                    ...
                    Editar Pagina Projeto
                </h1>
                <p class="page-subtitle">Atualize as informações e imagem do projeto #<?= $projeto['id_projeto'] ?></p>
            </div>
        </div>
    </div>
    ...
    <!-- Formulário -->
    <div class="form-card">
        <form action="/backend/pagina-projeto/atualizar/<?= $projeto['id_projeto'] ?>" method="POST" enctype="multipart/form-data" id="formPaginaProjeto">
            
            <!-- Hidden: imagem atual -->
            <input type="hidden" name="imagem_projeto_atual" value="<?= htmlspecialchars($projeto['imagem_projeto'] ?? '') ?>">
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" 
                                   ...
                                   name="nome_projeto" 
                                   class="form-control" 
                                   value="<?= htmlspecialchars($projeto['nome_projeto']) ?>"
                    ...
                    <div class="form-group full-width">
                        <label for="descricao_projeto" class="form-label">
                            Descrição do projeto <span class="required">*</span>
                        </label>
                        <div class="textarea-wrapper">
                            ...
                            <textarea id="descricao_projeto" 
                                      ...
                                      rows="6"
                                      placeholder="Descreva o projeto de forma atrativa..."
                                      minlength="10"
                                      maxlength="1000"
                                      required><?= htmlspecialchars($projeto['descricao_projeto']) ?></textarea>
                        </div>
                        <small class="form-hint">
                            <span id="char-count"><?= strlen($projeto['descricao_projeto']) ?></span>/1000 caracteres
                        </small>
                    </div>

                    <div class="form-group full-width">
                        <label for="status_projeto" class="form-label">
                        ...
                        <div class="status-selector-edit">
                            <label class="status-option-edit">
                                <input type="radio" 
                                       name="status_projeto" 
                                       value="Ativo" 
                                       <?= (strcasecmp($projeto['status_projeto'], 'Ativo') === 0) ? 'checked' : '' ?>>
                            ...
                            <label class="status-option-edit">
                                <input type="radio" 
                                       name="status_projeto" 
                                       value="Inativo" 
                                       <?= (strcasecmp($projeto['status_projeto'], 'Inativo') === 0) ? 'checked' : '' ?>>
                        ...
                        <small class="form-hint">Define se o projeto aparece no site público</small>
                    </div>
                </div>
            </div>
                ...
                <div class="upload-area" id="uploadArea">
                    ...
                    <div class="preview-container" id="previewContainer" style="display: none;">
                        ...
                        <div class="preview-overlay">
                            <button type="button" class="btn-change-image" onclick="document.getElementById('imagem_projeto').click()">
            ...
            <div class="info-box info-secondary">
                ...
                <div class="info-content">
                    <?php if (!empty($projeto['atualizado_em'])): ?>
                    <strong>Última atualização:</strong> 
                    <?= date('d/m/Y \à\s H:i', strtotime($projeto['atualizado_em'])) ?>
                    <br>
                    <?php endif; ?>
                    <strong>Criado em:</strong> 
                    <?= date('d/m/Y \à\s H:i', strtotime($projeto['criado_em'])) ?>
                </div>
            </div>

            <!-- Botões de Ação -->
            <div class="form-actions">
                <a href="/backend/pagina-projeto/listar" class="btn-secondary">
...
const fileInput = document.getElementById('imagem_projeto');
...
document.getElementById('formPaginaProjeto').addEventListener('submit', function(e) {
