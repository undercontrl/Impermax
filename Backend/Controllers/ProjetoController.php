...
class ProjetoController{
    ...
    if (!$sucesso) {
        Redirect::redirecionarComMensagem("projeto/listar", "success", "Serviço atualizado com sucesso!");
    } else {
        Redirect::redirecionarComMensagem("projeto/editar/$id", "error", "Erro ao atualizar o serviço!");
    }
}
