    ...
    <table class="table table-striped table-bordered align-middle">
        <thead class="table-dark">
            <tr>
                ...
                <th scope="col">Status</th> <!-- Nova coluna para clareza -->
        ...
        <tbody>
            <?php foreach($servicos as $servico): 
                 ...
                 $statusLabel = $servico["status_servico"] === 'Inativo' ? '<span class="badge bg-danger">Inativo</span>' : '<span class="badge bg-success">Ativo</span>';
            ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="/backend/servico/excluir/<?php echo $servico['id_servico']; ?>" class="btn btn-sm btn-danger"><?php echo $label; ?></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
